...
void Matrix<T>::SixteenBlockMatrixMultiplicationAlgorithm<Derived>::validate_divide_and_conquer_inputs(const Matrix<T>& matrix, const Matrix<T>& other) {
...
template<typename T>
template<typename Derived>
Matrix<T> Matrix<T>::SixteenBlockMatrixMultiplicationAlgorithm<Derived>::extract_from_padded(const Matrix<T>& padded_result, size_type original_size) {
