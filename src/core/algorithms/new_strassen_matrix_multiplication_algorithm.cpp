...
// NewStrassenMatrixMultiplicationAlgorithm class implementation
template<typename T>
Matrix<T> Matrix<T>::NewStrassenMatrixMultiplicationAlgorithm::multiply(const Matrix<T>& matrix, const Matrix<T>& other) {
...
template<typename T>
Matrix<T> Matrix<T>::NewStrassenMatrixMultiplicationAlgorithm::strassen_recursive(const Matrix<T>& A, const Matrix<T>& B) {
    size_type n = A.rows();
...
template<typename T>
Matrix<T> Matrix<T>::NewStrassenMatrixMultiplicationAlgorithm::strassen_2x2(const Matrix<T>& A, const Matrix<T>& B) {
    Matrix result(2, 2);
